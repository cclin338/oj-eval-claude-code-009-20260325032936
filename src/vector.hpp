...
public:
	...
	public:
        iterator(T* ptr = nullptr, const vector* container = nullptr) : ptr_(ptr), container_(container) {}
    ...
    public:
        const_iterator(const T* ptr = nullptr, const vector* container = nullptr) : ptr_(ptr), container_(container) {}

        const_iterator(const const_iterator& other) : ptr_(other.ptr_), container_(other.container_) {}
